...
class SyncScheduler:
    ...
    def _get_intervals(self) -> tuple[int, int]:
        """Return (downstream_interval, upstream_interval) from DB or .env defaults."""
    ...
    async def downstream_loop(self):
        while self.is_running:
            ...
            logger.info(f"Next downstream sync in {downstream_interval}s")
