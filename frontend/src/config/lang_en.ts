...
export const lang_en: TranslationKeys = {
  ...
  clinicalNote: {
    ...
    predefinedTextsPlaceholder: 'Predefined Texts',
  ...
  userSettings: {
    ...
    predefinedTextsTab: 'Predefined Texts',
    predefinedTextsDesc: 'Manage texts you can quickly insert when creating clinical notes.',
    newTextTitle: 'Text name',
    newTextContent: 'Content',
    newTextTitlePlaceholder: 'E.g.: Standard evolution',
    newTextContentPlaceholder: 'Write the predefined text...',
    addText: 'Add',
    noTexts: 'No predefined texts. Add the first one above.',
    active: 'Active',
    inactive: 'Inactive',
