export const lang_es = {
  ...
  header: {
    ...
    sslWarningShort: 'Cert. SSL',
    sslWarningTooltip: 'Conexión establecida con el servidor central, pero el certificado SSL no es de confianza. Los datos se sincronizan, aunque la conexión no está cifrada correctamente.',
  },
  ...
  episodes: {
    ...
    sslWarning: 'Cert. SSL no confiable',
    dataReception: 'Recepción de datos',
    hl7Send: 'Envío de datos',
    never: 'Nunca',
  ...
  clinicalNote: {
    ...
    predefinedTextsPlaceholder: 'Textos Predefinidos',
  ...
  userSettings: {
    ...
    predefinedTextsTab: 'Textos Predefinidos',
    predefinedTextsDesc: 'Administra los textos que puedes insertar rápidamente al crear notas clínicas.',
    newTextTitle: 'Nombre del texto',
    newTextContent: 'Contenido',
    newTextTitlePlaceholder: 'Ej: Evolución estándar',
    newTextContentPlaceholder: 'Escribe el texto predefinido...',
    addText: 'Agregar',
    noTexts: 'Sin textos predefinidos. Agrega el primero arriba.',
    active: 'Activo',
    inactive: 'Inactivo',
